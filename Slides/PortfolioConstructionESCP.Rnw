...
\draw [fill = green] (2, 2) circle [radius = 0.05];
\pause
\node at (0, 1) [left] {rf};
\pause
...
\draw [fill = green] (2.5, 1.75) circle [radius = 0.05];
\pause
...
\node at (2.5, 1.75) [below right] {\scriptsize Market Portfolio};
\pause
\draw [fill = green] (3.5, 2.5) circle [radius = 0.05];
\node at (3.5, 2.5) [left] {\scriptsize Small Capitalisation};
\pause
\draw [fill = green] (1.5, 1.5) circle [radius = 0.05];
\node at (1.5, 1.5) [left] {\scriptsize Value};
\pause
\draw [fill = green] (3.5, 2.0) circle [radius = 0.05];
