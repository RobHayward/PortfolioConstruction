...
\begin{itemize}[<+-| alert@+>]
\pause
\item \textbf{Value:} behavioural bias of pro-cyclical investment (De Bondt and Thaler (1985) and Fama French (??)
\item \textbf{Growth:} behavioural bias of pro-cyclical investment (De Bondt and Thaler (1985) and Fama French (??)
\item \textbf{Small cap:} Increased risk of small firms, liquidity or access to funding (Fama French (??)
\item \textbf{Momentum:} behavioural and institutional serial correlaton (Jagadesh and Titman (??)
