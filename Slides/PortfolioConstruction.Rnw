...
\definecolor{MyBrown}{RGB}{125, 90, 8}
\usepackage{multirow}
...
\node at (2, 1) [align = center] {\scriptsize Ang, Brandt, Denison (2014)};
\end{tikzpicture}
\end{frame}
...
\end{itemize}
\item Other: term, liquidity, credit 
\end{itemize}
\end{frame}
...
\item Arnott, R,. J.C. Hsu and Philip Moore (2005, "Fundamental Indexation", Financial Analystis Journal", Vol 61 No. 2. pp 83-89
...
\item De Bondt, W. R. Thaler, (1995), "Does the Stock Market Overreaact?", Jornal of Finance, vol 40, No 3, 793-803 
