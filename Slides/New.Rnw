...
\item Increased active investment 27\%
\item Increased use of smart beta 49\%
\item Bring investment in-house 38\%
\item Decrase use of passive investment 28\%
\item Increase use of passive investment 23\%
\item Decreate use of active investmetn 0\%
\end{itemize}
\end{frame}
\end{document}
“It may be the case that a large portion of an aggregate portfolio’s active risk is explained by factor risk. Certain desirable risk factor exposures, such as an overweight to small caps, could be captured more cost-effectively with a smart beta portfolio.” Lori Heinel, Chief Portfolio Strategist, SSGA

There is a common belief that more smart beta and more active management will be used to reduce the gap between performance and requirements. Three quarter of those introducing smart beta reported moderate to significant improvement in their ability to hit long-term targets.

Though smart beta needs a long-term approach, there is evidence of short-term pressure. Only being give 1 year of underperformance. More work is needed on smart beta. What conditions allow it to work?